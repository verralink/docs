...
description: The Public Marketplace is a global trading hub where all players can buy, sell, and exchange items and services across the entire VerraLink community.

---

## Overview
The Public Marketplace connects the **entire VerraLink community** into one global trading hub. Unlike the Guild Marketplace, which is limited to members of a single guild, the Public Marketplace is open to all players, creating a diverse economy that spans across Verra.  
...
1. Navigate to the **Character Menu → Storefront**, then select **Public Marketplace**  
...
- **Public Marketplace**: global, connecting the entire VerraLink community  

---

## Notes
- The Public Marketplace is designed to complement guild economies, not replace them  
