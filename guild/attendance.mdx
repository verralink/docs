...
2. Create a new **Activity Template** by setting the name, description, DKP weight, and other options. make sure that the **type** of template is set to **discord only or all**

3. During the event type  

```
/attendance <DROP DOWN ACTIVITY>
```
