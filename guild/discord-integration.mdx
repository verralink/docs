...
- **`/join`** - Allows players to apply to be linked to join a guild directly through Discord.  
- **`/check`** – Verify which server members are not in the guild but have the member role in discord 
