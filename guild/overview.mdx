...
### Loadouts
Complement Party Management by creating templates and grouping users by either static groups(Assign individual users to specific parties) or role based (1 Tank, 4 Dps, 2 Healers.. etc)
